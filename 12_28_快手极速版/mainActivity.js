...
const COLOR = '#FFD700';
//声明脚本标题
const TITLE = '快手极速版_12_28_1';

//需要保存的空间ID
var viewIdArr = ['xhyc', 'xh', 'sh', 'zxsj'];
...
var UI = ui.inflate(
    <vertical>
        <horizontal>
            <text text='下滑延迟：'></text>
            <input id='xhyc' hint='4-8' w='*'></input>
        </horizontal>
        <horizontal>
            <text text='下滑：'></text>
            <input id='xh' hint=''></input>
            <text text='次，再上滑：'></text>
            <input id='sh' hint=''></input>
            <text text='次！'></text>
        </horizontal>
        <horizontal>
            <text text='在线时间：'></text>
            <input hint='120-130' w='*' id='zxsj'></input>
        </horizontal>
