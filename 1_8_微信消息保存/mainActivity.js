 ...
 * @LastEditors: BanHua
 * @LastEditTime: 2021-01-18 23:52:32
...
var userUI = (function(){
    return (
        <vertical>
            <horizontal>
                <text text='存储路径:'></text>
                <input hint='/sdcard/myFiles/' w='*' id='bh_cclj'></input>
            </horizontal>
            <horizontal>
                <text text='采集对象:'></text>
                <input hint='对象a|对象b' w='*' id='bh_cjdx'></input>
            </horizontal>
            <horizontal>
                <text text='*采集关键字:'></text>
                <input hint='关键字a|关键字b' w='*' id='bh_cjgjz'></input>
            </horizontal>            <horizontal>
                <text text='匹配范围:'></text>
                <input hint='0|300' w='*' id='bh_ppfw'></input>
            </horizontal>            <horizontal>
                <text text='初始日期:'></text>
                <input hint='年/月/日/时' w='*' id='bh_csrq'></input>
            </horizontal>            <horizontal>
                <text text='结束日期:'></text>
                <input hint='年/月/日/时' w='*' id='bh_jsrq'></input>
            </horizontal>
        </vertical>
    )
})();
