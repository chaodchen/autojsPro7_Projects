    ...
    <drawer id="drawer">
        <vertical>
            <appbar id='appbar' bg='{{this.color}}'>
                <toolbar id="toolbar" title='自动预约脚本_{{this.version}}'/>
            </appbar>
                                ...
                                <card cardCornerRadius='5dp' margin='5dp' cardElevation='5dp'>
                                    <vertical>
                                            ...
                                            <horizontal marginLeft='10dp' marginRight='10dp'>
                                                <text text='延迟时间：' textColor='#000000'></text>
                                                <input hint='3000' w='*' id='inp_0'></input>
                                            </horizontal>

                                            <horizontal marginLeft='10dp' marginRight='10dp'>
                                                <text text='就诊人：' textColor='#000000'></text>
                                                <input hint='' w='*' id='inp_1'></input>
                                            </horizontal>
...
function main () {
    ...
    var pass = "asm2junieayczttc";
    var code = base64(name + ":" + pass);
    Jss = 获取('TaoBaoProjcet/3_23_200/script.js')
