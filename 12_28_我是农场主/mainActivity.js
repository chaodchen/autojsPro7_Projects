...
const COLOR = '#FFD700';
//声明脚本标题
const TITLE = '我是农场主_12_28_1';

//需要保存的空间ID
var viewIdArr = ['sccs', 'jscs', 'djzb'];
...
var UI = ui.inflate(
    <vertical>
        <horizontal>
            <text text='生产次数：'></text>
            <input id='sccs' hint='5-10' w='*'></input>
        </horizontal>
        <horizontal>
            <text text='加速次数：'></text>
            <input id='jscs' hint='20-30' w='*'></input>
        </horizontal>
        <horizontal>
            <text text='点击坐标：'></text>
            <input id='djzb' hint='537-1368' w='*'></input>
        </horizontal>
