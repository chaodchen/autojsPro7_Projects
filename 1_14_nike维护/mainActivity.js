 ...
 * @LastEditors: BanHua
 * @LastEditTime: 2021-01-18 14:38:19
...
var userUI = (function(){
    return (
        <vertical>
            <horizontal>
                <text text='运行脚本名称:'></text>
                <input hint='NIKE注册' w='*' id='bh_jbName'></input>
            </horizontal>
            <horizontal>
                <text text='卸载软件名称:'></text>
                <input hint='SNKRS' w='*' id='bh_xzApkName'></input>
            </horizontal>
            <horizontal>
                <text text='等待时间:'></text>
                <input hint='2400' w='*' id='bh_delay'></input>
            </horizontal>
            <horizontal>
                <text text='安装包路径:'></text>
                <input hint='/sdcard/Pictures/com.nike.snkrs_3.1.2_2020121112.apk' w='*' id='bh_apkPath'></input>
            </horizontal>
            <button id='getRoot' w='*' text='获取Root'></button>
        </vertical>
    )
})();
