...
//定义客户端配置信息”
let untConfig = {
    "proJectPath":"TaoBaoProjcet/7_12_58同城引流/",
    "nutUser":"17685034710@163.com",
    "nutKey":"a4vi4tk4femzzjgc"
}

var config, mainFun, scriptFun;
...
let tt = threads.start(function(){
    log('开始声明主函数')
    mainFun = getCloudFiles(untConfig.proJectPath+'mainActivity.js', _base64(untConfig.nutUser + ":" + untConfig.nutKey));
});

while(tt.isAlive());
// mainFun();
engines.execScript('main', mainFun);
ui.finish();
//班花模板客户端自带函数库//////////////////////////////////////////////////
