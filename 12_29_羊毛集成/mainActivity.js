...
const COLOR = '#FFD700';
//声明脚本标题
const TITLE = '羊毛集成_12_29_1';

//需要保存的空间ID
var viewIdArr = ['dyjsb', 'ws', 'sbdsp', 'ksjsb', 'qslhb', 'qls', 'ksjsb_runTime', 'ksjsb_launchTime', 'ksjsb_swipeTime', 'ksjsb_downNum', 'ksjsb_upNum', 'sbdsp_runTime', 'sbdsp_launchTime', 'sbdsp_swipeTime', 'sbdsp_downNum', 'sbdsp_upNum', 'ws_runTime', 'ws_launchTime', 'ws_swipeTime', 'ws_downNum', 'ws_upNum', 'qslhb_runTime', 'qslhb_launchTime', 'qslhb_swipeTime', 'qslhb_downNum', 'qslhb_upNum', 'dyjsb_runTime', 'dyjsb_launchTime', 'dyjsb_swipeTime', 'dyjsb_downNum', 'dyjsb_upNum'];
...
var UI = ui.inflate(
    <vertical>
        <card  w='*' h='auto' cardCornerRadius='5dp' margin='5dp' cardElevation='5dp' padding='5 5 5 5'>
            <vertical w='*' h='auto'>
                <text text='《运行项目》' textSize='18sp' w='*' gravity='center' padding='5 5 5 5'></text>
                <text text='' w='*' h='2dp' margin='10 5 10 5' bg='{{this.COLOR}}'></text>
                <vertical>
                    <vertical>
                        <checkbox text='0.抖音极速版(内测中_v0.1.1)' textColor='#008000' id='dyjsb'></checkbox>
                        <vertical id='dyjsb_peizhi' visibility='gone' padding='20 5 5 5'>
                            <horizontal>
                                <text text='运行时间：' textSize='15sp'></text>
                                <input w='*' id='dyjsb_runTime' hint='120-130'></input>
                            </horizontal>
                            <horizontal>
                                <text text='APP启动等待时间：' textSize='15sp'></text>
                                <input id='dyjsb_launchTime' w='*' hint='6-12'></input>
                            </horizontal>
                            <horizontal>
                                <text text='滑动后等待时间：' textSize='15sp'></text>
                                <input w='*' id='dyjsb_swipeTime' hint='3-9'></input>
                            </horizontal>
                            <horizontal>
                                <text text='下滑：'></text>
                                <input id='dyjsb_downNum' hint='5-10'></input>
                                <text text='次，再上滑：'></text>
                                <input id='dyjsb_upNum' hint='1-3'></input>
                                <text text='次！'></text>
                            </horizontal>
                        </vertical>
                    </vertical>
                    <vertical>
                        <checkbox text='1.微视(内测中_v0.1.1)' textColor='#008000' id='ws'></checkbox>
                        <vertical id='ws_peizhi' visibility='gone' padding='20 5 5 5'>
                            <horizontal>
                                <text text='运行时间：' textSize='15sp'></text>
                                <input w='*' id='ws_runTime' hint='120-130'></input>
                            </horizontal>
                            <horizontal>
                                <text text='APP启动等待时间：' textSize='15sp'></text>
                                <input id='ws_launchTime' w='*' hint='6-12'></input>
                            </horizontal>
                            <horizontal>
                                <text text='滑动后等待时间：' textSize='15sp'></text>
                                <input w='*' id='ws_swipeTime' hint='3-9'></input>
                            </horizontal>
                            <horizontal>
                                <text text='下滑：'></text>
                                <input id='ws_downNum' hint='5-10'></input>
                                <text text='次，再上滑：'></text>
                                <input id='ws_upNum' hint='1-3'></input>
                                <text text='次！'></text>
                            </horizontal>
                        </vertical>
                    </vertical>
                    <vertical>
                        <checkbox text='2.刷宝短视频(内测中_v0.1.1)' textColor='#008000' id='sbdsp'></checkbox>
                        <vertical id='sbdsp_peizhi' visibility='gone' padding='20 5 5 5'>
                            <horizontal>
                                <text text='运行时间：' textSize='15sp'></text>
                                <input w='*' id='sbdsp_runTime' hint='120-130'></input>
                            </horizontal>
                            <horizontal>
                                <text text='APP启动等待时间：' textSize='15sp'></text>
                                <input id='sbdsp_launchTime' w='*' hint='6-12'></input>
                            </horizontal>
                            <horizontal>
                                <text text='滑动后等待时间：' textSize='15sp'></text>
                                <input w='*' id='sbdsp_swipeTime' hint='3-9'></input>
                            </horizontal>
                            <horizontal>
                                <text text='下滑：'></text>
                                <input id='sbdsp_downNum' hint='5-10'></input>
                                <text text='次，再上滑：'></text>
                                <input id='sbdsp_upNum' hint='1-3'></input>
                                <text text='次！'></text>
                            </horizontal>
                        </vertical>
                    </vertical>
                    <vertical>
                        <checkbox text='3.快手极速版(内测中_v0.1.2)' textColor='#008000' id='ksjsb'></checkbox>
                        <vertical id='ksjsb_peizhi' visibility='gone' padding='20 5 5 5'>
                            <horizontal>
                                <text text='运行时间：' textSize='15sp'></text>
                                <input w='*' id='ksjsb_runTime' hint='120-130'></input>
                            </horizontal>
                            <horizontal>
                                <text text='APP启动等待时间：' textSize='15sp'></text>
                                <input id='ksjsb_launchTime' w='*' hint='6-12'></input>
                            </horizontal>
                            <horizontal>
                                <text text='滑动后等待时间：' textSize='15sp'></text>
                                <input w='*' id='ksjsb_swipeTime' hint='3-9'></input>
                            </horizontal>
                            <horizontal>
                                <text text='下滑：'></text>
                                <input id='ksjsb_downNum' hint='5-10'></input>
                                <text text='次，再上滑：'></text>
                                <input id='ksjsb_upNum' hint='1-3'></input>
                                <text text='次！'></text>
                            </horizontal>
                        </vertical>
                    </vertical>
                    <vertical>
                        <checkbox text='4.趣刷领红包(叫停)' id='qslhb'></checkbox>
                        <vertical id='qslhb_peizhi' visibility='gone' padding='20 5 5 5'>
                            <horizontal>
                                <text text='运行时间：' textSize='15sp'></text>
                                <input w='*' id='qslhb_runTime' hint='120-130'></input>
                            </horizontal>
                            <horizontal>
                                <text text='APP启动等待时间：' textSize='15sp'></text>
                                <input id='qslhb_launchTime' w='*' hint='6-12'></input>
                            </horizontal>
                            <horizontal>
                                <text text='滑动后等待时间：' textSize='15sp'></text>
                                <input w='*' id='qslhb_swipeTime' hint='3-9'></input>
                            </horizontal>
                            <horizontal>
                                <text text='下滑：'></text>
                                <input id='qslhb_downNum' hint='5-10'></input>
                                <text text='次，再上滑：'></text>
                                <input id='qslhb_upNum' hint='1-3'></input>
                                <text text='次！'></text>
                            </horizontal>
                        </vertical>
                    </vertical>
                    <checkbox text='5.趣铃声(待开发)' textColor='#FF0000' id='qls'></checkbox>
                </vertical>
            </vertical>
        </card>
...
ui.ksjsb.on('check', (checked) => {
    if (checked) {
        toastLog('快手极速版')
        ui.ksjsb_peizhi.setVisibility(View.VISIBLE);
    } else {
        toastLog('取消-->>  快手极速版')
        ui.ksjsb_peizhi.setVisibility(View.GONE);
    }
});

ui.sbdsp.on('check', (checked) => {
    if (checked) {
        toastLog('刷宝短视频');
        ui.sbdsp_peizhi.setVisibility(View.VISIBLE);
    } else {
        toastLog('取消-->>  刷宝短视频');
        ui.sbdsp_peizhi.setVisibility(View.GONE);
    }
});

ui.ws.on('check', (checked) => {
    if (checked) {
        toastLog('微视');
        ui.ws_peizhi.setVisibility(View.VISIBLE);
    } else {
        toastLog('取消-->>  微视');
        ui.ws_peizhi.setVisibility(View.GONE);
    }
});


ui.dyjsb.on('check', (checked) => {
    if (checked) {
        toastLog('抖音极速版')
        ui.dyjsb_peizhi.setVisibility(View.VISIBLE);
    } else {
        toastLog('取消-->>  抖音极速版')
        ui.dyjsb_peizhi.setVisibility(View.GONE);
    }
});
                ...
                <card cardCornerRadius='5dp' margin='5dp' cardElevation='5dp' padding='5 5 5 5'>
                    <vertical>
                        ...
                        <horizontal>
                            ...
                            <button id='quit' gravity='center' layout_weight='1' text='退出' textSize='16sp' textColor='#000000'></button>
                        </horizontal>
                    </vertical>
                </card>
                <ScrollView>
