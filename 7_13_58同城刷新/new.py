    ...
    while 1:
        ...
        if(start_flag == False):
            ...
            if("登录" in html_login.text):
                ...
                sess = requests.session()
                header ={'Cookie': 'bid=mTyCOa6IVcM; douban-fav-remind=1; __utmc=30149280; ll="118172"; ps=y; push_doumail_num=0;'
            ...
            if(cookie_login_flag == False):
                print("* 获取ck... *")
                url_ck = "https://www.douban.com/group/topic/144511002/?start=0"
        ...
        while 1:
            if(start_flag == True):
                urls = [r'https://www.douban.com/group/topic/144511002',
                        r'https://www.douban.com/group/topic/144253712',
                        ]
                url_len = len(urls)
