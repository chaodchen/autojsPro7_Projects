    ...
    <vertical id='vertical_1' padding='5dp'>
        <ScrollView>
            <vertical>
                ...
                <text w='*' gravity='center' text='下拉菜单' layout_gravity='center' margin='5dp'></text>
                <vertical id='spinnerParent'>
...
// //渲染下拉菜单
// config.uiConfig.spinnerView.map((_view, _index) => {
//     if (_view) {
//         _view.id = 'spinnerView' + _index
//         this._view = _view
//         ui.inflate(
//             <spinner id='{{_view.id}}' entries='{{_view.entries}}' spinnerMode='{{_view.spinnerMode}}'></spinner>
//             ,ui.spinnerParent, true
//         )
//     }
// })
