...
//可留空
函数库路径 = 'AutoJs_Mods/mods.js'

//本地储存 = storages.create(代号)
UI配置 = 本地储存.get('UI配置') || {}

编辑框控件组 = [
    [{text:'系统_白名单路径：'}, {hint:'/sdcard/开头'}],
    [{text:'系统_qq号文件名：'}, {hint:'白名单路径下的文件名称'}],
    [{text:'系统_qq昵文件名：'}, {hint:'白名单路径下的文件名称'}],
    [{text:'系统_头像包路径：'}, {hint:'白名单路径下的文件夹名称'}],
    [{text:'系统_账号数据保存文件名：'}, {hint:'白名单路径下的文件名称'}],
    [{text:'用户_联众帐号：'}, {}],
    [{text:'用户_联众密码：'}, {}],
    [{text:'用户_应用id：'}, {}],
    [{text:'用户_应用key：'}, {}],
