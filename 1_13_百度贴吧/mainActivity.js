 ...
 * @LastEditors: BanHua
 * @LastEditTime: 2021-01-14 01:47:08
...
var userUI = (function(){
    return (
        <vertical>
            <horizontal>
                <text text='*延迟时间：'></text>
                <input hint='xx-xx分钟' w='*' id='bh_delay'></input>
            </horizontal>
            <horizontal>
                <text text='随机字符数量：'></text>
                <input hint='1-3/默认为2' w='*' id='bh_rstr_num'></input>
            </horizontal>
            <horizontal>
                <text text='评论后多久删除：'></text>
                <input hint='xx-xx秒/默认为10秒' w='*' id='bh_delete_delay'></input>
            </horizontal>
        </vertical>
    )
})();
